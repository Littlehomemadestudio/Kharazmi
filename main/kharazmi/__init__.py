...
The application is built with PySide6 and uses a single, opinionated
Gold-on-Dark theme. There are no themes to switch between — the visual
language is part of the product.
"""

__version__ = "2.0.0"
__author__ = "Littlehomemadestudio"
__all__ = ["__version__"]
