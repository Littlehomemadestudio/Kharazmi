...
**RASK!** یک برنامه دسکتاپ حرفه‌ای برای تقویم شمسی، مدیریت پروژه و برنامه‌ریزی هوشمند با هوش مصنوعی است. این نرم‌افزار با الهام از نام بزرگ‌ترین دانشمند ریاضیات ایران، **محمد بن موسی خوارزمی**، طراحی شده و ترکیبی از سنت و تکنولوژی مدرن را ارائه می‌دهد.
...
<p align="center">
<img src="assets/logo.png" alt="RASK! Calendar" width="300"/>
</p>

RASK! دارای یک سیستم تقویم شمسی کامل و بومی‌سازی‌شده است:
...
> RASK! دستیار هوشمند شماست که با استفاده از مدل **GLM-4.5-Flash**، برنامه‌ریزی پروژه‌ها را متحول می‌کند.
...
RASK! ابزارهای حرفه‌ای مدیریت پروژه را در یک محیط یکپارچه ارائه می‌دهد:
...
۳. RASK! یک گراف برنامه‌ریزی پیچیده با شاخه‌های موازی تولید می‌کند
...
└── 📂 ui/                       # رابط کاربری (PySide6)
    ...
    ├── rask_window.py          # پنجره یکپارچه RASK!
...
RASK! از یک پالت رنگی طلایی-تاریک لوکس استفاده می‌کند:
...
از مشارکت شما در RASK! استقبال می‌کنیم! 🎉
...
*RASK! — یادگاری از دانش ناب ایرانیان در عصر طلایی ریاضیات* ✨
